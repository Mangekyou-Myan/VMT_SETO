...
namespace Valve.VR
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct VREyeTrackingData_t
    {
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct VRTextureMotionInfo_t
    {
        public IntPtr handle; // void *
        public HmdMatrix44_t mDeltaPose;
    }
    [StructLayout(LayoutKind.Sequential)]
    public struct VRTextureWithMotion_t
    {
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct DistortionCoordinate_t
    {
        public float u;
        public float v;
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct PathWriteOptions_t
    {
        [MarshalAs(UnmanagedType.I1)]
